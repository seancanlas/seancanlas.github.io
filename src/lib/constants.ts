...
export const projects: Project[] = [
  {
    ...
    image: '/images/maplelinecards-dark-1.webp',
    images: ['/images/maplelinecards-dark-1.webp', '/images/maplelinecards-dark-3.webp', '/images/maplelinecards-dark-2.webp'],
    imageLight: '/images/maplelinecards-light-1.webp',
    imagesLight: ['/images/maplelinecards-light-1.webp', '/images/maplelinecards-light-3.webp', '/images/maplelinecards-light-2.webp'],
  ...
  {    id: 'craveitmakeit',
    ...
    image: '/images/craveitmakeit-dark-1.webp',
    images: ['/images/craveitmakeit-dark-1.webp', '/images/craveitmakeit-dark-2.webp', '/images/craveitmakeit-dark-3.webp'],
    imageLight: '/images/craveitmakeit-light-1.webp',
    imagesLight: ['/images/craveitmakeit-light-1.webp', '/images/craveitmakeit-light-2.webp', '/images/craveitmakeit-light-3.webp'],
